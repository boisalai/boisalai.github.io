...
- [Guides](#guides)
- [Concepts and Basic Blocks](#concepts)
...
- [The Data Incubator](https://www.thedataincubator.com/fellowship.html)
...
- [Pattern Recognition and Machine Learning](https://www.amazon.ca/Pattern-Recognition-Machine-Learning-Christopher/dp/0387310738/ref=sr_1_1?ie=UTF8&qid=1539517256&sr=8-1&keywords=Pattern+Recognition+and+Machine+Learning)
- [A high-bias, low-variance introduction to Machine Learning for physicists](https://arxiv.org/abs/1803.08823), [notebooks](https://physics.bu.edu/~pankajm/MLnotebooks.html).
- [Introduction to Applied Linear Algebra – Vectors, Matrices, and Least Squares, Stephen Boyd and Lieven Vandenberghe, Cambridge University Press](https://web.stanford.edu/~boyd/vmls)
- [Handbook of Mathematics for Engineers and Scientists](https://igortitara.files.wordpress.com/2010/04/handbook-of-math-for-engineers-and-scientists1.pdf)
- [The Matrix Calculus You Need For Deep Learning](https://explained.ai/matrix-calculus/index.html) and [here](https://arxiv.org/abs/1802.01528).
...
- 2018
  ...
  - [Deep Learning: The Super-Convergence phenomenon](https://www.linkedin.com/pulse/deep-learning-super-convergence-phenomenon-ibrahim-sobh/)
  - [AdamW and Super-convergence is now the fastest way to train neural nets](http://www.fast.ai/2018/07/02/adam-weight-decay/), Written: 02 Jul 2018 by Sylvain Gugger and Jeremy Howard
...
- Neural Information Processing Systems ([NIPS](https://nips.cc/))
  - [NeurIPS 2018](https://videos.videoken.com/index.php/videoscategory/neurips-2018/) and [here](https://www.facebook.com/pg/nipsfoundation/videos/).
...
- [A Short Introduction to Entropy, Cross-Entropy and KL-Divergence](https://www.youtube.com/watch?v=ErfnhcEV1O8), Aurélien Géron, 2018.
...
- [Optimizer in PyTorch Documentation](https://pytorch.org/docs/stable/optim.html)
...
- [Loss Functions in PyTorch Documentation](https://pytorch.org/docs/stable/nn.html#loss-functions)
...
- [Fastai Part 2 Lesson 9 wiki](https://forums.fast.ai/t/part-2-lesson-9-wiki/14028)
...
- [Deep learning object detection](https://github.com/hoya012/deep_learning_object_detection/blob/master/README.md)
- [Deep Learning for Object Detection: A Comprehensive Review](https://towardsdatascience.com/deep-learning-for-object-detection-a-comprehensive-review-73930816d8d9)
- [Mean average precision (mAP)](https://forums.fast.ai/t/mean-average-precision-map/14345)
...
- SSD (Single Shot MultiBox Detector)
  - [SSD: Single Shot MultiBox Detector](https://arxiv.org/abs/1512.02325)
    - 8732? See https://forums.fast.ai/t/part-2-lesson-9-wiki/14028/394
...
- YOLOv3 (it is switching to the SSD method...)
  ...
  - [YoloV3 in Pytorch and Jupyter Notebook](https://github.com/ydixon/yolo_v3)
- Image segmentation
...
- Ricky T. Q. Chen, Yulia Rubanova, Jesse Bettencourt, David Duvenaud. "Neural Ordinary Differential Equations." *Advances in Neural Processing Information Systems*. 2018. [[arxiv](https://arxiv.org/abs/1806.07366)]
- [This](https://github.com/llSourcell/Neural_Differential_Equations/) is the code for "Neural DIfferential Equations" By Siraj Raval on Youtube
...
- [Demystifying Generative Adversarial Networks](https://towardsdatascience.com/demystifying-generative-adversarial-networks-c076d8db8f44)
- [PyTorch implementation of the paper Progressive Growing Of GANS For Improved Quality, Stability, And Variation by Karras et al.](https://github.com/nvnbny/progressive_growing_of_gans)
...
- [TRFL](https://github.com/deepmind/trfl) (pronounced "truffle") is a library built on top of TensorFlow that exposes several useful building blocks for implementing Reinforcement Learning agents.
...
- [Readable implementation of a Capsule Network as described in "Dynamic Routing Between Capsules" [Hinton et. al.]](https://github.com/cezannec/capsule_net_pytorch)
- [Capsule Networks](https://cezannec.github.io/Capsule_Networks/)
- [Dynamic Routing Between Capsules](https://s3.amazonaws.com/video.udacity-data.com/topher/2018/November/5bfdca4f_dynamic-routing/dynamic-routing.pdf)
...
- [Understanding Different Convolution Neural Network Architectures](https://www.kaggle.com/shivamb/cnn-architectures-vgg-resnet-inception-alex?utm_medium=email&utm_source=mailchimp&utm_campaign=datanotes-20181018)
- Here's the Keras [documentation](https://keras.io/applications/) for accessing some famous CNN architectures.

- LeNet (1998)
- AlexNet (2012)
  - [AlexNet Implementation Using Keras](https://engmrk.com/alexnet-implementation-using-keras/)
...
- LSUN
- Microsoft COCO (Common Objects in Context): 100k images, 80 classes, detection labels.
- MNIST
  ...
  - [http://deeplearning.net/data/mnist/](http://deeplearning.net/data/mnist/)
  - [The MNIST Database of handwritten digits](http://yann.lecun.com/exdb/mnist/)
  - [pytorch/examples/.../mnist](https://github.com/pytorch/examples/blob/master/mnist/main.py)
- PASCAL VOC (for image object detection and localization)
...
- [Making the Best of Jupyter](https://github.com/NirantK/best-of-jupyter#getting-started-right)
- [5 easy steps to start editing python notebooks over SSH](http://fizzylogic.nl/2017/11/06/edit-jupyter-notebooks-over-ssh/)
- [Zero Configuration Remote Jupyter Server](http://www.justinkiggins.com/blog/zero-configuration-remote-jupyter-server/) and [here](https://gist.github.com/AdamGagorik/248bedfcccd5e9a0b6f953fa1dc87f1a)
...
- [How to run an IPython/Jupyter Notebook on a remote machine](http://kawahara.ca/how-to-run-an-ipythonjupyter-notebook-on-a-remote-machine/)
...
- [CS230 Introduction to PyTorch Code Examples](https://cs230-stanford.github.io/pytorch-getting-started.html)
- [PyTorch Forum](https://discuss.pytorch.org/)
- [WHAT IS TORCH.NN REALLY?](https://pytorch.org/tutorials/beginner/nn_tutorial.html) by Jeremy Howard, fast.ai. Thanks to Rachel Thomas and Francisco Ingham.
...
- [demos](http://ml4a.github.io/demos/?fbclid=IwAR0eepdW3eoqHkfoZSoF6TbW2YR8TRFC8p80KJ1vO3MgfbAo7vLoIfnLEsQ)  
...
- [Welcome to GCP! from fastai](https://github.com/fastai/course-v3/blob/master/docs/start_gcp.md)
...
- [Build your own top-spec remote-access Machine Learning rig: a very detailed assembly and installation guide for a dual boot Ubuntu 16.04/Win 10 with CUDA 8 run on i7 6850K with 2x GTX 1080Ti GPUs](https://medium.com/@aragalie/build-your-own-top-spec-remote-access-machine-learning-rig-a-very-detailed-assembly-and-dae0f4011a8f)
